    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 60, 6, 1846);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(60:4) {#if $active === \\\"All Tasks\\\"}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 67, 6, 2043);
    			attr_dev(div, "class", "uk-flex-1");
    			add_location(div, file$1, 66, 4, 2013);
    			attr_dev(a0, "href", "#");
    			...
    			add_location(form, file$1, 54, 2, 1620);
    			attr_dev(li3, "data-tags", li3_data_tags_value = /*object*/ ctx[0].project);
    			add_location(li3, file$1, 52, 0, 1508);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
